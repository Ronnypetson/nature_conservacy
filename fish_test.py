...
input_dir = "/root/Documents/Kaggle/Fish_classification/train/train"
...
def load_train():
    ...
    for fld in folders:
        ...
        path = os.path.join('..', 'Fish_classification', 'train/train', fld, '*.jpg')
...
def create_model():
    ...
    sgd = SGD(lr=2e-3, decay=1e-4, momentum=0.89, nesterov=False)
